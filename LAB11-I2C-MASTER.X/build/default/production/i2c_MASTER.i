...
I2C_IdleLoop:
    ...
    movf SSPCON2,W
    andlw 0x1F
    btfss STATUS,2 ; ((SSPCON2) and 07Fh), 0, ((SSPCON2) and 07Fh), 1, ((SSPCON2) and 07Fh), 2, ((SSPCON2) and 07Fh), 3, ((SSPCON2) and 07Fh), 4 cleared?
    goto I2C_IdleLoop
    return
...
I2C_Start:
    call I2C_WaitIdle
    BANKSEL SSPCON2
    bsf SSPCON2,0 ; ((SSPCON2) and 07Fh), 0 = 1, start condition
I2C_WaitStart:
    btfsc SSPCON2,0
    goto I2C_WaitStart
    BANKSEL PIR1 ; Clear ((PIR1) and 07Fh), 3 after start
    bcf PIR1,3
    return
...
;-----------------------------------------------------------
I2C_Stop:
    BANKSEL PIR1 ; Clear ((PIR1) and 07Fh), 3 before stop
    bcf PIR1,3
    BANKSEL SSPCON2
    bsf SSPCON2,2 ; ((SSPCON2) and 07Fh), 2 = 1, stop condition
I2C_WaitStop:
    btfsc SSPCON2,2
    goto I2C_WaitStop
    return
...
; - Clear ((PIR1) and 07Fh), 3 after ((SSPCON2) and 07Fh), 6 check
;-----------------------------------------------------------
I2C_WriteByte:
    BANKSEL SSPBUF
...
I2C_WaitTX:
    BANKSEL PIR1
    btfss PIR1,3 ; Wait until ((PIR1) and 07Fh), 3=1
    goto I2C_WaitTX
    ...
    BANKSEL PIR1
    bcf PIR1,3 ; Clear ((PIR1) and 07Fh), 3 after ACK check
    return
...
Start:
    ...
    movwf TRISA
    BANKSEL TRISC
    movlw 0b00011000 ; ((PORTC) and 07Fh), 3 (SDI), ((PORTC) and 07Fh), 4 (SCL) inputs
    movwf TRISC
    ...
    BANKSEL SSPSTAT
    movlw 0x80 ; ((SSPSTAT) and 07Fh), 7=1 standard speed
    movwf SSPSTAT
    BANKSEL SSPCON
    movlw 0x28 ; ((SSPCON) and 07Fh), 5=1, Master mode
    movwf SSPCON
    BANKSEL SSPADD
