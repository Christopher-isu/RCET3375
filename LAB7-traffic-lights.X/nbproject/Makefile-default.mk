...
${OBJECTDIR}/traffic_lights.o: traffic_lights.S  nbproject/Makefile-${CND_CONF}.mk 
	...
	traffic_lights.S \
	 -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -msummary=+mem,-psect,-class,-hex,-file,-sha1,-sha256,-xml,-xmlfull -Wa,-mcpu=PIC16F883,-alms -Wl,-presetVect=0h,-pisrVect=4h,-pcode=20h
...
${OBJECTDIR}/traffic_lights.o: traffic_lights.S  nbproject/Makefile-${CND_CONF}.mk 
	...
	-o ${OBJECTDIR}/traffic_lights.o \
	traffic_lights.S \
	  -mdfp="${DFP_DIR}/xc8"  -msummary=+mem,-psect,-class,-hex,-file,-sha1,-sha256,-xml,-xmlfull -Wa,-mcpu=PIC16F883,-alms -Wl,-presetVect=0h,-pisrVect=4h,-pcode=20h
